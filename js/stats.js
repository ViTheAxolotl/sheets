...
function init()
{
    ...
    for(let element of document.getElementsByClassName("spells")){element.oncontextmenu = function(e) {e.preventDefault(); handleActionRightClickRoll(toTitleCase(this.value));};}
